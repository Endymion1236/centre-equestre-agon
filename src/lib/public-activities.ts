...
import { CONSIGNE_ARRIVEE_BALADE_COURTE } from "@/lib/cgv-clauses";
...
export const PUBLIC_ACTIVITIES: PublicActivity[] = [
  {
    ...
    title: "Baby Poney",
    ages: "3 – 5 ans",
    schedule: "Du lundi au vendredi · 2h par jour (équitation + une autre séquence)",
    ...
    features: ["Chaque séance de 2h combine au moins 2 temps : équitation + une autre séquence (soins, éveil, jeux)", "Approche ludique et sensorielle", "Petits groupes", "Thèmes variés chaque semaine", "Découverte de la mini-ferme", "Soins et premiers gestes autour du poney"],
  ...
  },
  {
    ...
    features: ["Chaque séance de 2h combine au moins 2 temps : équitation + une autre séquence (soins, hippologie, jeux)", "Semaines thématiques immersives", "Jeux et parcours ludiques", "Soins aux poneys", "Découverte de la mini-ferme", "Progression vers les premiers galops"],
  ...
  },
  {
    ...
    features: ["Chaque séance de 2h combine au moins 2 temps : équitation + une autre séquence (soins, hippologie, théorie, voltige ou attelage)", "Travail en autonomie", "Technique aux trois allures", "Sellage et bridage", "Initiation à l’obstacle", "Sorties extérieures"],
  ...
  },
  {
    ...
    features: ["Chaque séance de 2h combine au moins 2 temps : équitation + une autre séquence (soins, hippologie, théorie, voltige ou attelage)", "Multi-disciplines", "CSO et dressage", "Pony Games", "Préparation aux galops FFE", "Cross et extérieur"],
  ...
  },
  {
    ...
    features: ["Chaque séance de 2h combine au moins 2 temps : équitation + une autre séquence (soins, hippologie, théorie, voltige ou attelage)", "Technique avancée", "CSO jusqu’à 80 cm selon le niveau", "Dressage sur le plat", "Préparation aux examens FFE", "Vidéo et débriefing selon les séances"],
  ...
  },
  {
    ...
    description: "Notre expérience phare : deux heures à cheval entre dunes, estuaire, Pointe d’Agon et plage, dans la lumière dorée du coucher de soleil.",
    intro: "C’est la sortie emblématique du centre. La lumière descend sur la côte et les dunes s’ouvrent sur la Pointe d’Agon, d’où l’on surplombe la mer et toute la plage. Débutants, débrouillés et confirmés partent dans des groupes distincts : les débutants profitent du panorama de la Pointe, les débrouillés descendent sur la plage au trot, les confirmés y galopent.",
    features: ["L’expérience signature du centre", "Départ dans la lumière du soir", "Groupes séparés par niveau", "Dunes, estuaire et panorama de la Pointe d’Agon", "Plage au trot pour les débrouillés, plage et galop pour les confirmés"],
    practical: [`${CONSIGNE_ARRIVEE_BALADE_COURTE} : préparation du cheval, matériel et consignes`, "Poids maximum 85 kg (toutes formules)", "Parcours selon le niveau : débutants dans les dunes et à la Pointe d’Agon (vue plongeante sur la mer) — plage au trot pour les débrouillés, plage et galop pour les confirmés", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et maîtrise des 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 €", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis", "Pantalon long et chaussures fermées", "Balade collective assurée à partir de 3 cavaliers inscrits — en dessous, nous proposons 2 jours avant le départ : maintien en petit comité avec un léger supplément, report à une autre date, avoir, ou remboursement intégral"],
  ...
  },
  {
    ...
    description: "Une promenade en pleine journée pour découvrir le littoral d’Agon-Coutainville, entre chemins, dunes, estuaire, Pointe d’Agon et plage.",
    intro: "Cette formule privilégie la découverte du paysage et le plaisir d’une sortie en bord de mer, avec le panorama de la Pointe d’Agon qui surplombe la mer et la plage. Les débutants profitent de la Pointe, les débrouillés descendent sur la plage au trot, les confirmés y galopent. Le parcours et le rythme sont adaptés au niveau du groupe ainsi qu’aux conditions de la journée.",
    features: ["Départ en journée", "Deux heures de promenade", "Panorama de la Pointe d’Agon", "Plage au trot pour les débrouillés, galop pour les confirmés", "Bon cadeau disponible"],
    practical: [`${CONSIGNE_ARRIVEE_BALADE_COURTE} : préparation du cheval, matériel et consignes`, "Poids maximum 85 kg (toutes formules)", "Parcours selon le niveau : débutants dans les dunes et à la Pointe d’Agon (vue plongeante sur la mer) — plage au trot pour les débrouillés, plage et galop pour les confirmés", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et maîtrise des 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 €", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis", "Pantalon long et chaussures fermées", "Maintien selon les conditions météo", "Balade collective assurée à partir de 3 cavaliers inscrits — en dessous, nous proposons 2 jours avant le départ : maintien en petit comité avec un léger supplément, report à une autre date, avoir, ou remboursement intégral"],
  ...
  },
  {
    ...
    practical: [`${CONSIGNE_ARRIVEE_BALADE_COURTE} : préparation du cheval, matériel et consignes`, "Sur demande et selon disponibilités", "Poids maximum 85 kg (toutes formules)", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et maîtrise des 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 €", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis"],
  ...
  },
  {
    ...
    practical: [`${CONSIGNE_ARRIVEE_BALADE_COURTE} : préparation du cheval, matériel et consignes`, "Niveau intermédiaire requis", "Tenue adaptée à la météo", "Prévoir gourde et affaires personnelles", "Dates annoncées dans le planning"],
  ...
  },
  {
    id: "cours-baby",
    category: "cours",
    title: "Baby poney à l’année",
    ages: "3 – 5 ans",
    schedule: "Une séance par semaine · année scolaire",
    description: "Le rendez-vous hebdomadaire des tout-petits : jeux, découverte du poney et premiers gestes, toute l’année à leur rythme.",
    intro: "Le baby poney n’existe pas qu’en stage : à l’année, la séance hebdomadaire devient un repère. L’enfant retrouve son groupe, son poney et une progression douce construite sur le jeu, les histoires et les soins.",
    features: ["Une séance hebdomadaire", "Approche ludique et sensorielle", "Petits groupes du même âge", "Poneys choisis pour les tout-petits", "Découverte des soins et de la mini-ferme"],
    practical: ["Inscription annuelle", "Tenue longue et chaussures fermées", "Casque fourni par le centre", "Un adulte reste présent pendant la séance"],
    gradient: "from-pink-500 to-rose-400",
    imageKey: "activite-baby-v2",
    price: "Tarif annuel",
    level: "Aucune expérience nécessaire",
    bookingLabel: "Voir les créneaux baby",
    vitrineKeys: ["cours_baby", "baby_annee"],
  },
  {
    id: "cours-compet",
    category: "cours",
    ...
    schedule: "Deux heures par semaine · année scolaire",
    description: "Deux heures chaque semaine : une heure de Pony Games et une heure de cours classique — ou deux heures de perfectionnement.",
    intro: "Le forfait intensif double le temps à cheval pour ceux qui veulent progresser vite. Deux formules au choix : l’heure de Pony Games associée à une heure de cours classique, ou deux heures de perfectionnement technique.",
    features: ["Deux heures hebdomadaires", "Formule 1 : 1h Pony Games + 1h cours classique", "Formule 2 : 2h de perfectionnement", "Préparation des concours et challenges internes", "Suivi des objectifs"],
