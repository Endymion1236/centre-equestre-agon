...
export const PUBLIC_ACTIVITIES: PublicActivity[] = [
  ...
  },
  {
    ...
    intro: "C’est la sortie emblématique du centre. La lumière descend sur la côte et les dunes s’ouvrent sur la Pointe d’Agon, d’où l’on surplombe la mer et toute la plage. Débutants, débrouillés et confirmés partent dans des groupes distincts, sur des parcours adaptés à leur niveau.",
    features: ["L’expérience signature du centre", "Départ dans la lumière du soir", "Groupes séparés par niveau", "Dunes, estuaire et panorama de la Pointe d’Agon", "Plage et galop pour les débrouillés et confirmés"],
  ...
  },
  {
    ...
    description: "Une promenade en pleine journée pour découvrir le littoral d’Agon-Coutainville, entre chemins, dunes, estuaire et Pointe d’Agon.",
    intro: "Cette formule privilégie la découverte du paysage et le plaisir d’une sortie en bord de mer, avec le panorama de la Pointe d’Agon qui surplombe la mer et la plage. Le parcours et le rythme sont adaptés au niveau du groupe ainsi qu’aux conditions de la journée.",
    features: ["Départ en journée", "Deux heures de promenade", "Panorama de la Pointe d’Agon", "Groupes par niveau", "Bon cadeau disponible"],
