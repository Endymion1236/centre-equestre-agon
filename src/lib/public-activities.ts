...
export const PUBLIC_ACTIVITIES: PublicActivity[] = [
  ...
  },
  {
    ...
    practical: ["Âge minimum 12 ans", "Poids maximum 85 kg", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis", "Pantalon long et chaussures fermées"],
  ...
  },
  {
    ...
    practical: ["Âge minimum 12 ans", "Poids maximum 85 kg", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis", "Pantalon long et chaussures fermées", "Maintien selon les conditions météo"],
  ...
  },
  {
    ...
    practical: ["Sur demande et selon disponibilités", "Âge minimum 12 ans", "Poids maximum 85 kg", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis"],
