...
export const PUBLIC_ACTIVITIES: PublicActivity[] = [
  ...
  },
  {
    ...
    practical: ["Poids maximum 85 kg (toutes formules)", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 € (sans quoi la promenade n’est pas remboursée si le niveau est insuffisant sur place)", "Pantalon long et chaussures fermées", "Niveau déclaré avec honnêteté : la sécurité en dépend"],
  ...
  },
  {
    ...
    practical: ["Poids maximum 85 kg (toutes formules)", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 € (sans quoi la promenade n’est pas remboursée si le niveau est insuffisant sur place)", "Pantalon long et chaussures fermées", "Maintien selon les conditions météo"],
