...
export const PUBLIC_ACTIVITIES: PublicActivity[] = [
  ...
  },
  {
    ...
    intro: "C’est la sortie emblématique du centre. La lumière descend sur la côte et les dunes s’ouvrent sur la Pointe d’Agon, d’où l’on surplombe la mer et toute la plage. Débutants, débrouillés et confirmés partent dans des groupes distincts : les débutants profitent du panorama de la Pointe, les débrouillés et les confirmés descendent sur la plage.",
    features: ["L’expérience signature du centre", "Départ dans la lumière du soir", "Groupes séparés par niveau", "Dunes, estuaire et panorama de la Pointe d’Agon", "Plage pour les débrouillés et confirmés, galop pour les confirmés"],
    practical: ["Poids maximum 85 kg (toutes formules)", "Parcours selon le niveau : débutants dans les dunes et à la Pointe d’Agon (vue plongeante sur la mer) — plage réservée aux débrouillés et confirmés, pour raisons de sécurité", "Débutants : dès 12 ans — Débrouillés : 12 ans, trot enlevé ou Galop 2 — Confirmés : 13 ans, bon Galop 3 et maîtrise des 3 allures", "En cas de doute sur le niveau : évaluation la veille à 10 €", "Niveau évalué par l’équipe au début de la promenade", "Aucun remboursement si le niveau constaté ne correspond pas au niveau requis", "Pantalon long et chaussures fermées"],
  ...
  },
  {
    ...
    intro: "Cette formule privilégie la découverte du paysage et le plaisir d’une sortie en bord de mer, avec le panorama de la Pointe d’Agon qui surplombe la mer et la plage. Les débutants profitent de la Pointe, les débrouillés et les confirmés descendent sur la plage. Le parcours et le rythme sont adaptés au niveau du groupe ainsi qu’aux conditions de la journée.",
    features: ["Départ en journée", "Deux heures de promenade", "Panorama de la Pointe d’Agon", "Plage pour les débrouillés et confirmés", "Bon cadeau disponible"],
