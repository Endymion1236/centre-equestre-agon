...
const choices: Choice[] = [
  {
    ...
    text: "Baby poney en stage de vacances ou à l’année : histoires, jeux et découverte de la mini-ferme.",
  ...
  },
  {
    ...
    text: "Tous les stages, du Baby Poney au Galop 3-4 : thèmes, autonomie et progression par petits groupes.",
  ...
  },
  {
    ...
    text: "Cours à l’année, Pony Games — la compétition phare du club — et challenges internes CSO et Équifun.",
    href: "/activites?profil=confirme#cours-loisir",
