  ...
  try {
    ...
    if (body.action === "extraire" || body.action === "extraire-operations" || body.action === "extraire-solde" || body.action === "extraire-page") {
      ...
      const consigneOperations =
        ...
        "Cas fréquents : « Commission vente à distance », « Com Carte », frais et factures Crédit Agricole → \"Frais bancaires & commissions (CB, Stripe)\". Allianz, Groupama, Helmet → \"Assurances\". CFE, taxe foncière, DGFiP hors TVA → \"Impôts & taxes\".\n" +
