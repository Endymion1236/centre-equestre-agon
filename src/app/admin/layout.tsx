...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/mes-documents", icon: FolderLock, label: "Mes documents", moniteur: true },
      { href: "/admin/registre-chutes", icon: AlertTriangle, label: "Registre des chutes", moniteur: true },
      { href: "/admin/mes-avis", icon: Star, label: "Mes avis", moniteur: true },
      { href: "/admin/recurrences", icon: RotateCw, label: "Récurrences" },
      // Diagnostic stages et Restaurer des créneaux : outils d'exception,
      // déplacés dans Paramètres → Maintenance pour alléger la barre latérale.
