            ...
            {groups.map(g => (
              ...
              return (
                <Card key={p.id} padding="md" className={`overflow-hidden border-l-4 ${isEcheance ? "border-l-orange-400" : "border-l-red-400"}`}>
                  ...
                  <button type="button" onClick={() => toggle(p.id)} className="w-full flex items-center justify-between gap-3 bg-transparent border-none cursor-pointer text-left p-0">
