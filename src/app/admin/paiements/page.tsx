 ...
 */
async function retraitPointsFidelite(familyId: string, montantAvoir: number, label: string) {
...
export default function PaiementsPage() {
  ...
  const [multiEncaisser, setMultiEncaisser] = useState<{ familyId: string; familyName: string; payments: any[] } | null>(null);
  ...
  // d'inscription du planning, qui encaisse l'acompte d'un stage au comptoir.
  const enregistrerEncaissement = enregistrerEncaissementPartage;
  ...
  return (
    <div>
      ...
      {/* Barre d'onglets : elle passe à la ligne sur mobile plutôt que de
          ...
          hors champ : on ne défile pas latéralement quelque chose qu'on ne sait
