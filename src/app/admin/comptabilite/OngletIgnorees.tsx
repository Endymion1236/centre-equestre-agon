...
/**
 * src/app/admin/comptabilite/OngletIgnorees.tsx
 *
 * Onglet « Ignorées » : les lignes bancaires volontairement écartées du
 * rapprochement (commissions, frais, virements personnels…).
 *
 * Pourquoi un onglet dédié plutôt qu'une suppression : une ligne ignorée reste
 * une ligne du relevé. La faire disparaître rendrait le total du relevé
 * incohérent et empêcherait de revenir sur une décision. Ici elle est visible,
 * comptée, et restaurable d'un clic.
 */
...
export function OngletIgnorees({
  bankLines, nbIgnores, updateAndSaveBankLines,
}: {
  bankLines: BankLine[];
  nbIgnores: number;
