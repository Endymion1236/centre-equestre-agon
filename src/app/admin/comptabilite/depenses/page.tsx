...
type Ligne = { id: string; dateOperation?: string; fournisseur: string; montant: number; poste: string; compte?: string; note?: string; source: string; suivie: boolean; rapprochementExclu?: boolean; statutTVA?: string; piece: Piece | null };
...
export default function DepensesPage() {
  ...
  const visibles = lignes.filter(l => (filtre === "exclues" ? l.rapprochementExclu : !l.rapprochementExclu && (filtre !== "manquantes" || !l.piece) && (filtre !== "sans-tva" || l.statutTVA === "sans-tva")) && `${l.fournisseur} ${l.poste} ${l.montant} ${l.compte}`.toLowerCase().includes(recherche.toLowerCase())).sort((a, b) => (a.dateOperation || "").localeCompare(b.dateOperation || ""));
