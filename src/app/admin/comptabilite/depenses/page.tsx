...
export default function DepensesPage() {
  ...
  return <main className="max-w-7xl mx-auto p-6 space-y-5">
    ...
    {vue === "pieces" ? <><p>Documents en attente et archives. Pour associer un paiement, revenez au tableau des opérations.</p><PiecesSansLigne /></> : vue === "synthese" ? <VueParPoste /> : <>
      ...
      <p>{actives.length} lignes actives · {actives.filter(l => !l.piece && !l.justificatifReleve && !l.depensePersonnelle).length} sans justificatif. Un débit classé dans une catégorie de charge entre dans la synthèse des charges, justifié ou non ; salaires, virements internes et emprunts restent hors synthèse.</p>
