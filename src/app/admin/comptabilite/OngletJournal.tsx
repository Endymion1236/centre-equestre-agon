...
/**
 * src/app/admin/comptabilite/OngletJournal.tsx
 *
 * Onglet « Journal des ventes » : la liste des factures de la période, suivie
 * des avoirs, suivie du total.
 *
 * Pourquoi les avoirs sont affichés dans un bloc à part, en rouge, et non
 * fondus dans la liste : ce ne sont pas des factures mais des encaissements
 * négatifs (collection `encaissements`, drapeau `isAvoir`). Les mélanger
 * fausserait les colonnes HT/TVA — un avoir n'a pas de détail de TVA — d'où
 * les tirets dans ces colonnes et un sous-total distinct.
 */
...
export function OngletJournal({
  filteredPayments, encaissementsCompta, period, totalHT, totalTVA, totalTTC,
}: {
