 ...
 *
 * Onglet « Réductions & promos » : codes promo et réductions automatiques
 * (1ère année, anniversaire, parrainage), stockés dans `settings/promos`
 * sous la clé `items`.
 *
 * Pourquoi séparé : la liste est éditable ligne par ligne (activation,
 * suppression, édition détaillée) et représente à elle seule près de 200 lignes
 * de JSX. Ces réductions sont consommées par les forfaits annuels ET les
 * paiements : le champ `appliesTo` décide lequel des deux.
 *
...
export default function SectionReductions({ promos, setPromos, loadingPromos, savePromos }: Props) {
  return (
