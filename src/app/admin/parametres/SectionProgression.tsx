 ...
 *
 * L'échelle de progression : les cinq libellés de niveau, et à partir duquel
 * un acquis compte comme validé pour la FFE.
 *
 * Les libellés se retrouvent sur les fiches de progression envoyées aux
 * familles : les changer change ce que les familles lisent.
 */
