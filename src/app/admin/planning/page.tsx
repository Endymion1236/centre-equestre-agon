  ...
  const handleEditSave = async () => {
    ...
    try {
      const update: any = {
        ...
        // Promenade au niveau fixé par la première inscription (balades).
        niveauADefinir: !!editForm.niveauADefinir,
        niveauFixe: editForm.niveauADefinir && editForm.niveauFixe ? editForm.niveauFixe : null,
