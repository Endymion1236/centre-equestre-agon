...
import { SITE_CONFIG, SCHEDULE } from "@/lib/config";
    ...
    <>
      ...
      <section className="relative bg-hero pt-32 pb-20 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mx-auto mb-4"><Phone size={32} className="text-white/80" /></div>
              ...
              {[
                {
                  ...
                  sub: `À ${SITE_CONFIG.distanceToBeach} de la plage`,
                },
                {
                  icon: "📞",
                  title: "Téléphone",
