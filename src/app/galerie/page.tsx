      ...
      <main className="bg-cream">
        <EditableImage imageKey="hero-plage" mode="background" label="Changer le fond" className="relative overflow-hidden px-6 pb-24 pt-36 text-center sm:pb-28 sm:pt-40" style={{ minHeight: "500px" }}>
          ...
          <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center">
            ...
            <div className="mt-6 font-body text-[11px] font-bold uppercase tracking-[0.2em] text-gold-300">La vie du centre en images</div>
        ...
        <section className="px-6 py-20 sm:py-24">
          <div className="mx-auto max-w-[1080px]">
            <div className="mx-auto mb-10 max-w-2xl text-center"><div className="font-body text-[11px] font-bold uppercase tracking-[0.18em] text-gold-500">Albums</div><h2 className="mt-3 font-display text-3xl font-bold text-blue-950 sm:text-4xl">Choisissez un univers</h2><p className="mt-4 font-body text-base leading-relaxed text-slate-500">Chaque album est alimenté depuis l’administration du site afin de faire remonter les images les plus récentes.</p></div>
        ...
        <section className="bg-white px-6 py-20">
          <div className="mx-auto grid max-w-[1000px] overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#07111f,#12346b)] text-white shadow-[0_22px_60px_rgba(12,26,46,0.14)] md:grid-cols-[1fr_auto] md:items-center">
            <div className="p-7 sm:p-9"><div className="flex items-center gap-2 font-body text-[11px] font-bold uppercase tracking-[0.16em] text-gold-300"><Images size={15} /> Encore plus d’images</div><h2 className="mt-3 font-display text-2xl font-bold text-white">Suivez les actualités du centre sur Facebook</h2><p className="mt-3 max-w-2xl font-body text-sm leading-relaxed text-white/55">Photos de la semaine, informations pratiques, résultats et coulisses du club y sont publiés régulièrement.</p></div>
