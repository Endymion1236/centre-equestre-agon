    ...
    <>
      ...
      <section className="py-20 px-6 bg-cream">
        <div className="max-w-[1180px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { emoji: "🏖️", title: "À 800m de la plage", desc: "Galops sur le sable, couchers de soleil à cheval... un cadre unique classé Natura 2000." },
              { emoji: "👶", title: "Dès 3 ans", desc: "Du Baby Poney pour les tout-petits au perfectionnement pour les confirmés." },
              { emoji: "🏆", title: "Compétition FFE", desc: "Pony Games, CSO, Équifun — préparation aux championnats de France à Lamotte-Beuvron." },
              { emoji: "🐷", title: "Mini-ferme", desc: "Cochons Kune Kune, chèvres, poules — un espace pédagogique qui émerveille les enfants." },
            ].map((item, i) => (
      ...
      <section className="py-24 px-6 max-w-[1180px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { emoji: "🏇", title: "Stages vacances", desc: "Baby Poney, Galop de Bronze, d'Argent, d'Or... Semaines thématiques inoubliables.", age: "Dès 3 ans", price: "175", gradient: "from-blue-500 to-blue-400", href: "/activites" },
            { emoji: "🌅", title: "Balades plage", desc: "2h entre dunes, estuaire et plage. Au coucher du soleil, c'est magique.", age: "Dès 12 ans", price: "53", gradient: "from-orange-500 to-orange-400", href: "/activites" },
            { emoji: "📅", title: "Cours réguliers", desc: "Forfaits annuels, 1 ou 2 cours par semaine. Progressez toute l'année.", age: "Tous niveaux", gradient: "from-gold-400 to-gold-300", href: "/activites" },
            { emoji: "🎂", title: "Anniversaires", desc: "Une fête au milieu des poneys ! Jeux, balade et goûter inclus.", age: "Dès 4 ans", gradient: "from-red-400 to-orange-400", href: "/contact" },
          ].map((activity, i) => (
        ...
        <div className="max-w-[900px] mx-auto relative z-10 flex flex-wrap items-center gap-12">
          ...
          <div className="flex-1 min-w-[200px] flex justify-center">
            <div className="grid grid-cols-2 gap-3">
              {[
                { emoji: "🦄", label: "Baby Poney", sub: "3-5 ans" },
                { emoji: "🥉", label: "Galop Bronze", sub: "6-8 ans" },
                { emoji: "🥈", label: "Galop Argent", sub: "8-10 ans" },
                { emoji: "🥇", label: "Galop d'Or", sub: "8+ ans" },
              ].map((s, i) => (
        ...
        <div className="max-w-[1000px] mx-auto flex flex-wrap items-center gap-12">
          ...
          <div className="flex-1 min-w-[250px]">
            <div className="grid grid-cols-2 gap-4">
              {[
                { emoji: "🐷", name: "Pépita", type: "Kune Kune roux" },
                { emoji: "🐷", name: "Ronron", type: "Kune Kune blanc" },
                { emoji: "🐐", name: "Les chèvres", type: "Chèvres naines" },
                { emoji: "🐔", name: "Les poules", type: "Pondeuses" },
              ].map((a, i) => (
