/* Copie figée du rapprochement bancaire tel qu'il tournait sur main avant la refactorisation de septembre 2026
 * (src/app/admin/comptabilite/page.tsx, lignes 859-1601, commit 7458e7c6). Ne pas modifier : c'est la référence
 * contre laquelle rapprochement-matching.ts est comparé par tests/unit/rapprochement-differentiel.test.ts. */
/* eslint-disable */
export function rapprocherReleveAncien(parsed: any[], etat: { encaissementsCompta: any[]; payments: any[]; remises: any[]; remisesSepa: any[]; period: string; bankLines: any[] }) {
  ...
  return { finalMatched, autoOverwritten, manuelsPreserves: previousManualByKey.size, usedEncIds, usedRemiseSepaIds, usedPaymentIds, usedRemiseIds };
}
